...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "A short description of IpassFrameWork1."
  ...
  spec.homepage     = "http://EXAMPLE/IpassFrameWork1"
  ...
  spec.source       = { :git => "http://EXAMPLE/IpassFrameWork1.git", :tag => "#{spec.version}" }
